# Original: https://github.com/DadaNanjesha/AI-Text-Humanizer-App/blob/main/transformer/app.py (MIT License)
# Modified for integration into this project.
"""Utilities to humanize academic text."""
import ssl
import random
import warnings
...
class AcademicTextHumanizer:
    ...
    def _select_closest_synonym(self, original_word, synonyms):
        ...
        max_score_index = int(cos_scores.argmax().item())
        max_score = float(cos_scores[max_score_index].item())
        if max_score >= 0.5:
